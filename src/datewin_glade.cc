// generated 2006/4/25 12:13:28 CEST by jacek@jaceksdell.(none)
...
{  datewin = this;
   ...
   notebook->signal_switch_page().connect(SigC::slot(*this, &datewin_glade::on_datewin_change_current_page), true);
