// generated 2005/12/19 18:42:54 CET by christof@vesta.petig-baender.de
...
{  datewin = this;
   ...
   Gtk::Label *datum_label = Gtk::manage(new class Gtk::Label(""));
   ...
   notebook->append_page(*hbox9, *datum_label);
