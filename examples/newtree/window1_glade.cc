// generated 2006/6/19 17:40:26 CEST by christof@vesta.petig-baender.de
...
{  window1 = this;
   ...
   button_test->set_relief(Gtk::RELIEF_NORMAL);
   ...
   vbox1->show();
   window1->show();
   button1->signal_clicked().connect(SigC::slot(*this, &window1_glade::add_one), false);
   button2->signal_clicked().connect(SigC::slot(*this, &window1_glade::eine_weg), false);
   button3->signal_clicked().connect(SigC::slot(*this, &window1_glade::refresh), false);
   button4->signal_clicked().connect(SigC::slot(*this, &window1_glade::change1), false);
   button5->signal_clicked().connect(SigC::slot(*this, &window1_glade::change2), false);
   button_test->signal_clicked().connect(SigC::slot(*this, &window1_glade::on_button_test_clicked), false);
}
